...
LAKE_LOCAL_CONSISTENCY_MATRIX_DIR = LAKE_LOCAL_CONSISTENCY_DIR / "matrix"
LAKE_LOCAL_CONSISTENCY_CONFIG_ENV_DIR = LAKE_LOCAL_CONSISTENCY_DIR / "config_env"
LAKE_LOCAL_CONSISTENCY_SETTINGS_DOCS_DIR = LAKE_LOCAL_CONSISTENCY_DIR / "settings_docs"
LAKE_LOCAL_CONSISTENCY_PATHS_DATALAKE_DIR = LAKE_LOCAL_CONSISTENCY_DIR / "paths_datalake"
LAKE_LOCAL_CONSISTENCY_SCRIPT_REPORT_DIR = LAKE_LOCAL_CONSISTENCY_DIR / "script_report"
LAKE_LOCAL_CONSISTENCY_REPORT_DATALAKE_DIR = LAKE_LOCAL_CONSISTENCY_DIR / "report_datalake"
LAKE_LOCAL_CONSISTENCY_DOCS_PHASE_LOG_DIR = LAKE_LOCAL_CONSISTENCY_DIR / "docs_phase_log"
LAKE_LOCAL_CONSISTENCY_EVIDENCE_CONTROL_DIR = LAKE_LOCAL_CONSISTENCY_DIR / "evidence_control"
...
LAKE_LOCAL_CONSISTENCY_CONTRADICTIONS_DIR = LAKE_LOCAL_CONSISTENCY_DIR / "contradictions"
LAKE_LOCAL_CONSISTENCY_REFERENCES_DIR = LAKE_LOCAL_CONSISTENCY_DIR / "references"
LAKE_LOCAL_CONSISTENCY_RECONCILIATION_DIR = LAKE_LOCAL_CONSISTENCY_DIR / "reconciliation"
LAKE_LOCAL_CONSISTENCY_COHERENCE_DIR = LAKE_LOCAL_CONSISTENCY_DIR / "coherence"
LAKE_LOCAL_CONSISTENCY_RECOMMENDATIONS_DIR = LAKE_LOCAL_CONSISTENCY_DIR / "recommendations"
LAKE_LOCAL_CONSISTENCY_VALIDATION_DIR = LAKE_LOCAL_CONSISTENCY_DIR / "validation"
LAKE_LOCAL_CONSISTENCY_QUALITY_DIR = LAKE_LOCAL_CONSISTENCY_DIR / "quality"

REPORTS_LOCAL_CONSISTENCY_DIR = REPORTS_DIR / "output" / "local_consistency"
REPORTS_LOCAL_CONSISTENCY_CSV_DIR = REPORTS_LOCAL_CONSISTENCY_DIR / "csv"
REPORTS_LOCAL_CONSISTENCY_MD_DIR = REPORTS_LOCAL_CONSISTENCY_DIR / "markdown"
REPORTS_LOCAL_CONSISTENCY_TXT_DIR = REPORTS_LOCAL_CONSISTENCY_DIR / "txt"
REPORTS_LOCAL_CONSISTENCY_JSON_DIR = REPORTS_LOCAL_CONSISTENCY_DIR / "json"
...
ADVANCED_CONTINUATION_NO_GO_SAFE_GO_DIR = os.path.join(ADVANCED_CONTINUATION_DIR, "no_go_safe_go")
ADVANCED_CONTINUATION_SCORING_DIR = os.path.join(ADVANCED_CONTINUATION_DIR, "scoring")
ADVANCED_CONTINUATION_VALIDATION_DIR = os.path.join(ADVANCED_CONTINUATION_DIR, "validation")
ADVANCED_CONTINUATION_QUALITY_DIR = os.path.join(ADVANCED_CONTINUATION_DIR, "quality")
ADVANCED_CONTINUATION_REPORTS_DIR = os.path.join(REPORTS_DIR, "output", "advanced_continuation")
ADVANCED_CONTINUATION_REPORTS_CSV_DIR = os.path.join(ADVANCED_CONTINUATION_REPORTS_DIR, "csv")
ADVANCED_CONTINUATION_REPORTS_MD_DIR = os.path.join(ADVANCED_CONTINUATION_REPORTS_DIR, "markdown")
ADVANCED_CONTINUATION_REPORTS_TXT_DIR = os.path.join(ADVANCED_CONTINUATION_REPORTS_DIR, "txt")
ADVANCED_CONTINUATION_REPORTS_JSON_DIR = os.path.join(ADVANCED_CONTINUATION_REPORTS_DIR, "json")
ADVANCED_CONTINUATION_DOCS_DIR = os.path.join(DOCS_DIR, "generated", "advanced_continuation")
ADVANCED_CONTINUATION_DOCS_ROADMAP_DIR = os.path.join(ADVANCED_CONTINUATION_DOCS_DIR, "roadmap")
...
ADVANCED_RUNTIME_MODULES_DIR = os.path.join(ADVANCED_RUNTIME_DIR, "modules")
ADVANCED_RUNTIME_DEPENDENCIES_DIR = os.path.join(ADVANCED_RUNTIME_DIR, "dependencies")
ADVANCED_RUNTIME_CONTRACTS_DIR = os.path.join(ADVANCED_RUNTIME_DIR, "contracts")
...
ADVANCED_RUNTIME_SCORING_DIR = os.path.join(ADVANCED_RUNTIME_DIR, "scoring")
ADVANCED_RUNTIME_VALIDATION_DIR = os.path.join(ADVANCED_RUNTIME_DIR, "validation")
ADVANCED_RUNTIME_QUALITY_DIR = os.path.join(ADVANCED_RUNTIME_DIR, "quality")
ADVANCED_RUNTIME_REPORTS_DIR = os.path.join(REPORTS_DIR, "output", "advanced_runtime")
ADVANCED_RUNTIME_REPORTS_CSV_DIR = os.path.join(ADVANCED_RUNTIME_REPORTS_DIR, "csv")
ADVANCED_RUNTIME_REPORTS_MD_DIR = os.path.join(ADVANCED_RUNTIME_REPORTS_DIR, "markdown")
ADVANCED_RUNTIME_REPORTS_TXT_DIR = os.path.join(ADVANCED_RUNTIME_REPORTS_DIR, "txt")
ADVANCED_RUNTIME_REPORTS_JSON_DIR = os.path.join(ADVANCED_RUNTIME_REPORTS_DIR, "json")
ADVANCED_RUNTIME_DOCS_DIR = os.path.join(DOCS_DIR, "generated", "advanced_runtime")
ADVANCED_RUNTIME_DOCS_CONTEXT_DIR = os.path.join(ADVANCED_RUNTIME_DOCS_DIR, "context")
...
def ensure_project_directories() -> None:
    ...
    """
    directories = [
        ADVANCED_CONTINUATION_DIR,
        ADVANCED_CONTINUATION_PROFILES_DIR,
        ADVANCED_CONTINUATION_ROADMAP_DIR,
        ADVANCED_CONTINUATION_MASTER_PLAN_DIR,
        ADVANCED_CONTINUATION_REOPEN_DIR,
        ADVANCED_CONTINUATION_AUDIT_DIR,
        ADVANCED_CONTINUATION_GAPS_DIR,
        ADVANCED_CONTINUATION_FUNCTIONAL_CONTINUATION_DIR,
        ADVANCED_CONTINUATION_DEPENDENCIES_DIR,
        ADVANCED_CONTINUATION_MILESTONES_DIR,
        ADVANCED_CONTINUATION_RISKS_DIR,
        ADVANCED_CONTINUATION_NO_GO_SAFE_GO_DIR,
        ADVANCED_CONTINUATION_SCORING_DIR,
        ADVANCED_CONTINUATION_VALIDATION_DIR,
        ADVANCED_CONTINUATION_QUALITY_DIR,
        ...
        LOGS_DIR,
        REPORTS_DIR,
        LAKE_LOCAL_CONSISTENCY_DIR,
        LAKE_LOCAL_CONSISTENCY_CHECK_REGISTRY_DIR,
        LAKE_LOCAL_CONSISTENCY_MATRIX_DIR,
        LAKE_LOCAL_CONSISTENCY_CONFIG_ENV_DIR,
        LAKE_LOCAL_CONSISTENCY_SETTINGS_DOCS_DIR,
        LAKE_LOCAL_CONSISTENCY_PATHS_DATALAKE_DIR,
        LAKE_LOCAL_CONSISTENCY_SCRIPT_REPORT_DIR,
        LAKE_LOCAL_CONSISTENCY_REPORT_DATALAKE_DIR,
        LAKE_LOCAL_CONSISTENCY_DOCS_PHASE_LOG_DIR,
        LAKE_LOCAL_CONSISTENCY_EVIDENCE_CONTROL_DIR,
        LAKE_LOCAL_CONSISTENCY_METADATA_ARTIFACT_DIR,
        LAKE_LOCAL_CONSISTENCY_GRAPH_METADATA_DIR,
        LAKE_LOCAL_CONSISTENCY_TIMELINE_ARTIFACT_DIR,
        LAKE_LOCAL_CONSISTENCY_BACKUP_PACKAGING_SECRETS_DIR,
        LAKE_LOCAL_CONSISTENCY_NON_USE_POLICY_DIR,
        LAKE_LOCAL_CONSISTENCY_DISCLAIMERS_DIR,
        LAKE_LOCAL_CONSISTENCY_SAFETY_BOUNDARIES_DIR,
        LAKE_LOCAL_CONSISTENCY_CONTRADICTIONS_DIR,
        LAKE_LOCAL_CONSISTENCY_REFERENCES_DIR,
        LAKE_LOCAL_CONSISTENCY_RECONCILIATION_DIR,
        LAKE_LOCAL_CONSISTENCY_COHERENCE_DIR,
        LAKE_LOCAL_CONSISTENCY_RECOMMENDATIONS_DIR,
        LAKE_LOCAL_CONSISTENCY_VALIDATION_DIR,
        LAKE_LOCAL_CONSISTENCY_QUALITY_DIR,
        REPORTS_LOCAL_CONSISTENCY_DIR,
        REPORTS_LOCAL_CONSISTENCY_CSV_DIR,
        REPORTS_LOCAL_CONSISTENCY_MD_DIR,
        REPORTS_LOCAL_CONSISTENCY_TXT_DIR,
        REPORTS_LOCAL_CONSISTENCY_JSON_DIR,
        DOCS_GENERATED_LOCAL_CONSISTENCY_DIR,
        RAW_DATA_DIR,
        PROCESSED_DATA_DIR,
        CACHE_DIR,
        LAKE_DIR,
...
LAKE_LOCAL_READINESS_DIR = LAKE_DIR / "local_readiness"
LAKE_LOCAL_READINESS_GATES_DIR = LAKE_LOCAL_READINESS_DIR / "gates"
LAKE_LOCAL_READINESS_ACCEPTANCE_DIR = LAKE_LOCAL_READINESS_DIR / "acceptance"
LAKE_LOCAL_READINESS_PHASE_EVIDENCE_DIR = LAKE_LOCAL_READINESS_DIR / "phase_evidence"
LAKE_LOCAL_READINESS_OPERATOR_CHECKLISTS_DIR = LAKE_LOCAL_READINESS_DIR / "operator_checklists"
LAKE_LOCAL_READINESS_STABILIZATION_DIR = LAKE_LOCAL_READINESS_DIR / "stabilization"
LAKE_LOCAL_READINESS_DRY_RUN_COMMANDS_DIR = LAKE_LOCAL_READINESS_DIR / "dry_run_commands"
LAKE_LOCAL_READINESS_COMMAND_COVERAGE_DIR = LAKE_LOCAL_READINESS_DIR / "command_coverage"
LAKE_LOCAL_READINESS_DOCS_DIR = LAKE_LOCAL_READINESS_DIR / "docs"
LAKE_LOCAL_READINESS_TESTS_DIR = LAKE_LOCAL_READINESS_DIR / "tests"
LAKE_LOCAL_READINESS_DATALAKE_DIR = LAKE_LOCAL_READINESS_DIR / "datalake"
LAKE_LOCAL_READINESS_REPORTS_DIR = LAKE_LOCAL_READINESS_DIR / "reports"
LAKE_LOCAL_READINESS_SECURITY_DIR = LAKE_LOCAL_READINESS_DIR / "security"
LAKE_LOCAL_READINESS_BACKUP_PACKAGING_DIR = LAKE_LOCAL_READINESS_DIR / "backup_packaging"
LAKE_LOCAL_READINESS_CROSS_LAYER_DIR = LAKE_LOCAL_READINESS_DIR / "cross_layer"
LAKE_LOCAL_READINESS_LIMITATIONS_DIR = LAKE_LOCAL_READINESS_DIR / "limitations"
LAKE_LOCAL_READINESS_GAPS_DIR = LAKE_LOCAL_READINESS_DIR / "gaps"
LAKE_LOCAL_READINESS_MANUAL_REVIEW_DIR = LAKE_LOCAL_READINESS_DIR / "manual_review"
LAKE_LOCAL_READINESS_GO_NO_GO_DIR = LAKE_LOCAL_READINESS_DIR / "go_no_go"
LAKE_LOCAL_READINESS_HANDOFF_DIR = LAKE_LOCAL_READINESS_DIR / "handoff"
LAKE_LOCAL_READINESS_SCORING_DIR = LAKE_LOCAL_READINESS_DIR / "scoring"
LAKE_LOCAL_READINESS_RISKS_DIR = LAKE_LOCAL_READINESS_DIR / "risks"
LAKE_LOCAL_READINESS_VALIDATION_DIR = LAKE_LOCAL_READINESS_DIR / "validation"
LAKE_LOCAL_READINESS_QUALITY_DIR = LAKE_LOCAL_READINESS_DIR / "quality"

REPORTS_LOCAL_READINESS_DIR = REPORTS_OUTPUT_DIR / "local_readiness"
REPORTS_LOCAL_READINESS_CSV_DIR = REPORTS_LOCAL_READINESS_DIR / "csv"
REPORTS_LOCAL_READINESS_MD_DIR = REPORTS_LOCAL_READINESS_DIR / "markdown"
REPORTS_LOCAL_READINESS_TXT_DIR = REPORTS_LOCAL_READINESS_DIR / "txt"
REPORTS_LOCAL_READINESS_JSON_DIR = REPORTS_LOCAL_READINESS_DIR / "json"

DOCS_GENERATED_LOCAL_READINESS_DIR = DOCS_DIR / "generated" / "local_readiness"
...
PROJECT_DIRS = [
    ...
    LAKE_LOCAL_READINESS_DIR,
    LAKE_LOCAL_READINESS_GATES_DIR,
    LAKE_LOCAL_READINESS_ACCEPTANCE_DIR,
    LAKE_LOCAL_READINESS_PHASE_EVIDENCE_DIR,
    LAKE_LOCAL_READINESS_OPERATOR_CHECKLISTS_DIR,
    LAKE_LOCAL_READINESS_STABILIZATION_DIR,
    LAKE_LOCAL_READINESS_DRY_RUN_COMMANDS_DIR,
    LAKE_LOCAL_READINESS_COMMAND_COVERAGE_DIR,
    LAKE_LOCAL_READINESS_DOCS_DIR,
    LAKE_LOCAL_READINESS_TESTS_DIR,
    LAKE_LOCAL_READINESS_DATALAKE_DIR,
    LAKE_LOCAL_READINESS_REPORTS_DIR,
    LAKE_LOCAL_READINESS_SECURITY_DIR,
    LAKE_LOCAL_READINESS_BACKUP_PACKAGING_DIR,
    LAKE_LOCAL_READINESS_CROSS_LAYER_DIR,
    LAKE_LOCAL_READINESS_LIMITATIONS_DIR,
    LAKE_LOCAL_READINESS_GAPS_DIR,
    LAKE_LOCAL_READINESS_MANUAL_REVIEW_DIR,
    LAKE_LOCAL_READINESS_GO_NO_GO_DIR,
    LAKE_LOCAL_READINESS_HANDOFF_DIR,
    LAKE_LOCAL_READINESS_SCORING_DIR,
    LAKE_LOCAL_READINESS_RISKS_DIR,
    LAKE_LOCAL_READINESS_VALIDATION_DIR,
    LAKE_LOCAL_READINESS_QUALITY_DIR,
    REPORTS_LOCAL_READINESS_DIR,
    REPORTS_LOCAL_READINESS_CSV_DIR,
