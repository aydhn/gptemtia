...
def build_master_report_index(project_root: Path, profile: LocalSynthesisProfile) -> Tuple[pd.DataFrame, Dict]:
    ...
    return df, summarize_master_report_index(df)

def summarize_master_report_index(index_df: pd.DataFrame) -> Dict:
