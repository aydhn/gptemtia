...
write_file('tests/test_briefing_config.py', '''
import pytest
...
write_file('tests/test_briefing_labels.py', '''
...
write_file('tests/test_briefing_models.py', '''
...
write_file('tests/test_local_briefing_scripts_contract.py', '''
import pytest
