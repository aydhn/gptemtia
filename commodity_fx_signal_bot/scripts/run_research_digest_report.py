...
def parse_args():
    parser = argparse.ArgumentParser(description="Run Research Digest Report")
...
def main():
    ...
    tables, meta = pipeline.build_research_digest_report(save=args.save)
    logger.info("Research Digest Report generated successfully.")
