...
def main():
    parser = argparse.ArgumentParser(description="Run build_misuse_scenario_library")
    ...
    try:
        ...
        logger.info("Running build_misuse_scenario_library with profile %s", args.profile)
        pipeline.build_misuse_scenario_library(save=args.save)
        logger.info("Done.")
