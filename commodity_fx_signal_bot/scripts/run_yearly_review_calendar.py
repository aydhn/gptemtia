...
def main():
    parser = argparse.ArgumentParser(description="Run yearly review calendar")
    ...
    print(f"Running Run yearly review calendar with profile {args.profile}...")
    pipeline.build_yearly_review_calendar(save=args.save)
    print("Done.")
