...
def parse_args():
    parser = argparse.ArgumentParser(description="Run Analyst Brief Report")
    parser.add_argument("--profile", type=str, default="analyst_deep_brief_summaries", help="Report summary profile name")
...
def main():
    ...
    tables, meta = pipeline.build_analyst_brief_report(save=args.save)
    logger.info("Analyst Brief Report generated successfully.")
