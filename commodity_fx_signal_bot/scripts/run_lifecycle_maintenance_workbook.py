"""Run lifecycle maintenance workbook"""
import argparse
import sys
...
def main():
    parser = argparse.ArgumentParser(description="Run lifecycle maintenance workbook")
    ...
    print(f"Running Run lifecycle maintenance workbook with profile {args.profile}...")
    pipeline.build_lifecycle_maintenance_workbook(save=args.save)
    print("Done.")
