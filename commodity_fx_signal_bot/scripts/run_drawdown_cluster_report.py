...
def main():
    parser = argparse.ArgumentParser(description="Run Drawdown Cluster Report")
    ...
    logger.info(f"Running drawdown cluster report for timeframe {args.timeframe}")
    ...
    df, summary = pipeline.build_drawdown_cluster_report(
        specs,
