...
def main():
    parser = argparse.ArgumentParser(description="Run Final Consolidation Audit")
    ...
    print(f"Running Final Consolidation Audit...")
    dfs, summary = pipeline.build_final_consolidation_audit(save=True)

    print("\n--- Final Consolidation Audit Summary ---")
