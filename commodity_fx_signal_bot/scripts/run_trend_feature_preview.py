...
from reports.report_builder import build_trend_feature_preview_report
...
def parse_args():
    parser = argparse.ArgumentParser(description="Preview Trend Features")
