...
def main():
    parser = argparse.ArgumentParser(description="Run Snapshot Comparison Report")
    ...
    res, summary = pipeline.build_snapshot_comparison_report(save=save)
    print("Snapshot Comparison Report generated.")
    print(summary)
