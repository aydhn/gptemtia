...
def main():
    parser = argparse.ArgumentParser(description="Run Golden Output Report")
    ...
    df, summary = pipeline.build_golden_output_report(save=save)
    print("Golden Output Report generated.")
    print(summary)
