...
def parse_args():
    parser = argparse.ArgumentParser(description="Run Weekly Offline Review Pack")
    parser.add_argument("--profile", type=str, default="weekly_review_summaries", help="Report summary profile name")
...
def main():
    ...
    text, meta = pipeline.build_weekly_offline_review_pack(save=args.save)
    logger.info("Weekly Offline Review Pack generated successfully.")
