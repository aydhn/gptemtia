...
def main():
    parser = argparse.ArgumentParser(description="Run Large Run Stability Report")
    ...
    print("Running Large Run Stability Report...")
    df, summary = pipeline.build_large_run_stability_report(save=args.save)

    print("\n--- Large Run Stability Summary ---")
    for k, v in summary.items():
        print(f"{k}: {v}")

    print("\nLarge Run Stability check complete.")
