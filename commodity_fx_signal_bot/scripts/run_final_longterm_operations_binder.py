"""Run final longterm operations binder"""
import argparse
import sys
...
def main():
    parser = argparse.ArgumentParser(description="Run final longterm operations binder")
    ...
    print(f"Running Run final longterm operations binder with profile {args.profile}...")
    pipeline.build_final_longterm_operations_binder(save=args.save)
    print("Done.")
