...
def main():
    parser = argparse.ArgumentParser(description="Run build_redteam_domain_registry")
    ...
    try:
        ...
        logger.info("Running build_redteam_domain_registry with profile %s", args.profile)
        pipeline.build_redteam_domain_registry(save=args.save)
        logger.info("Done.")
