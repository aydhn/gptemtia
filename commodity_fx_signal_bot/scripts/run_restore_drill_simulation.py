...
def main():
    ...
    parser.add_argument("--profile", default="restore_traceability_focus")
    ...
    try:
        ...
        dfs, sum_dict = pipeline.build_restore_drill_simulation(save=args.save)
        print("Restore Drill Simulation generated successfully.")
