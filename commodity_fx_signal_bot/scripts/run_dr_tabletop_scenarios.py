...
def main():
    ...
    parser.add_argument("--profile", default="failure_playbook_focus")
    ...
    try:
        ...
        dfs, sum_dict = pipeline.build_dr_tabletop_scenarios(save=args.save)
        print("DR Tabletop Scenarios generated successfully.")
