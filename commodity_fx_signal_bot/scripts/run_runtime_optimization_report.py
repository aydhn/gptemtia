...
def main():
    parser = argparse.ArgumentParser(description="Run Runtime Optimization Report")
    ...
    print("Running Runtime Optimization Report...")
    df, summary = pipeline.build_runtime_optimization_report(save=args.save)

    print("\n--- Runtime Optimization Summary ---")
    for k, v in summary.items():
        print(f"{k}: {v}")

    print("\nRuntime Optimization checks complete.")
