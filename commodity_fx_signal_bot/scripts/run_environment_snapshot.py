...
def main():
    ...
    print(f"Running Environment Snapshot with profile: {args.profile}")
    ...
    df_map, summary = pipeline.build_environment_snapshot_report(save=args.save)
    print("Environment Snapshot generated.")
    print("Packages:", len(df_map.get("packages", [])))
