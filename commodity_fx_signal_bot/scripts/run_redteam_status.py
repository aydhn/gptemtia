...
def main():
    parser = argparse.ArgumentParser(description="Run build_redteam_status")
    ...
    try:
        ...
        logger.info("Running build_redteam_status with profile %s", args.profile)
        pipeline.build_redteam_status(save=args.save)
        logger.info("Done.")
