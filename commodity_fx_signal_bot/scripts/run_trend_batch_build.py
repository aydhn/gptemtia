...
from config.symbols import get_symbols_by_asset_class, get_symbol_spec, DEFAULT_SYMBOL_UNIVERSE
...
def main():
    ...
    logger.info(f"Batch completed. Success: {results['success_count']}, Failed: {results['failure_count']}, Skipped: {results['skipped_count']}")
