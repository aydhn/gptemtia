"""
Script to run the restore dry-run plan.
"""
import argparse
import sys
...
def main():
    parser = argparse.ArgumentParser(description="Run restore dry-run plan.")
    ...
    print(f"Running restore dry-run plan with profile {args.profile}...")
    df, summary = pipeline.build_restore_dry_run_plan(save=not args.no_save)
    print("Done. Summary:")
    print(summary)
