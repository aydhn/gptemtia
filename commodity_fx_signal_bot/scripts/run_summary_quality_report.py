...
def parse_args():
    parser = argparse.ArgumentParser(description="Run Summary Quality Report")
...
def main():
    ...
    quality, meta = pipeline.build_summary_quality_report(save=args.save)
    logger.info("Summary Quality Report generated successfully.")
