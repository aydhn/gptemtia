...
def main():
    parser = argparse.ArgumentParser(description="Run Performance Profile Report")
    parser.add_argument("--profile", type=str, default="balanced_local_performance", help="Performance profile name")
    parser.add_argument("--limit", type=int, default=None, help="Limit number of commands to profile")
    ...
    print(f"Running Performance Profile Report (Limit: {args.limit})...")
    dfs, summary = pipeline.build_performance_profile_report(limit=args.limit, save=args.save)
