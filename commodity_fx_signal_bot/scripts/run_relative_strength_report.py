...
logger = logging.getLogger("run_relative_strength_report")

def main():
    parser = argparse.ArgumentParser(description="Run relative strength report")
    ...
    logger.info(f"Running relative strength report. Profile: {args.profile}")
    df, summary = pipeline.build_relative_strength_report(
         specs=specs,
