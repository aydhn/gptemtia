"""
Script to run the restore verification report.
"""
import argparse
import sys
...
def main():
    parser = argparse.ArgumentParser(description="Run restore verification report.")
    ...
    print(f"Running restore verification report with profile {args.profile}...")
    df, summary = pipeline.build_restore_verification_report(save=not args.no_save)
    print("Done. Summary:")
    print(summary)
