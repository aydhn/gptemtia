...
def main():
    parser = argparse.ArgumentParser(description="Run build_redteam_quality_report")
    ...
    try:
        ...
        logger.info("Running build_redteam_quality_report with profile %s", args.profile)
        pipeline.build_redteam_quality_report(save=args.save)
        logger.info("Done.")
