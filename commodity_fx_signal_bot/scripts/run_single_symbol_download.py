...
def main():
    ...
    parser.add_argument("--symbol", required=True, help="Symbol to download (e.g. GC=F)")
    parser.add_argument("--interval", default=settings.default_interval, help="Data interval (e.g. 1d, 1h)")
    parser.add_argument("--period", default=settings.default_period, help="Data period (e.g. 1y, 6mo)")
    ...
    logger.info(f"Downloading data for {args.symbol} (interval: {args.interval}, period: {args.period})")
