...
def main():
    ...
    logger.info(f"Running run_final_delivery_bundle_manifest with profile {args.profile}")
    ...
    # write dummy outputs
    (out_dir / "txt" / "run_final_delivery_bundle_manifest_report.txt").write_text("ok")
