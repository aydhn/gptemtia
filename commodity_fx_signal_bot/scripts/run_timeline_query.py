"""
Script to execute a timeline query.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Run Timeline Query")
    parser.add_argument("--query", type=str, required=True, help="Timeline query text")
    ...
    try:
        ...
        results_df, summary = pipeline.build_timeline_query_report(query_text=args.query, save=not args.no_save)

        logger.info(f"Successfully processed query. Found {summary.get('total_results', 0)} results.")
