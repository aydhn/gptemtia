...
def main():
    parser = argparse.ArgumentParser(description="Run v1x roadmap governance")
    ...
    print(f"Running Run v1x roadmap governance with profile {args.profile}...")
    pipeline.build_v1x_roadmap_governance(save=args.save)
    print("Done.")
