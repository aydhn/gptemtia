...
def main():
    parser = argparse.ArgumentParser(description="Run build_adversarial_prompt_safety_checklist")
    ...
    try:
        ...
        logger.info("Running build_adversarial_prompt_safety_checklist with profile %s", args.profile)
        pipeline.build_adversarial_prompt_safety_checklist(save=args.save)
        logger.info("Done.")
