...
def main():
    parser = argparse.ArgumentParser(description="Run Resource Budget Report")
    ...
    print("Running Resource Budget Report...")
    dfs, summary = pipeline.build_resource_budget_report(save=args.save)

    print("\n--- Resource Budget Summary ---")
    for k, v in summary.items():
        print(f"{k}: {v}")

    print("\nResource Budget computation complete.")
