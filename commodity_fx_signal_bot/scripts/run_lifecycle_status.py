...
def main():
    parser = argparse.ArgumentParser(description="Run lifecycle status report")
    ...
    print(f"Running Run lifecycle status report with profile {args.profile}...")
    pipeline.build_lifecycle_status(save=args.save)
    print("Done.")
