...
def main():
    parser = argparse.ArgumentParser(description="Run longterm domain registry")
    ...
    print(f"Running Run longterm domain registry with profile {args.profile}...")
    pipeline.build_longterm_domain_registry(save=args.save)
    print("Done.")
