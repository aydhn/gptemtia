...
def main():
    parser = argparse.ArgumentParser(description="Run build_final_local_redteam_rehearsal")
    ...
    try:
        ...
        logger.info("Running build_final_local_redteam_rehearsal with profile %s", args.profile)
        pipeline.build_final_local_redteam_rehearsal(save=args.save)
        logger.info("Done.")
