"""
Script to generate the guided workflow report.
"""
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Run guided workflow report")
    ...
    print(f"Generating guided workflow report with profile {profile.name}...")
    ...
    df, summary = pipeline.build_guided_workflow_report(save=not args.no_save)

    print(f"Generated report with {summary['total_workflows']} workflows.")
