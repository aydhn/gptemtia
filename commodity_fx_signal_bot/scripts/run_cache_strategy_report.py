...
def main():
    parser = argparse.ArgumentParser(description="Run Cache Strategy Report")
    ...
    print("Running Cache Strategy Report...")
    dfs, summary = pipeline.build_cache_strategy_report(save=args.save)

    print("\n--- Cache Strategy Summary ---")
    for k, v in summary.items():
        print(f"{k}: {v}")

    print("\nCache Strategy computation complete.")
