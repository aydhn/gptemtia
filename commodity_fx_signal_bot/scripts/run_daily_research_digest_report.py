...
def main():
    parser = argparse.ArgumentParser(description="Generate Daily Research Digest Report")
    ...
    report, quality = pipeline.build_daily_digest(
        specs=specs,
    ...
    logger.info(f"Daily digest generated with {report.summary.get('processed_count')} symbols.")
