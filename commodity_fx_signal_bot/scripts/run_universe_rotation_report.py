...
logger = logging.getLogger("run_universe_rotation_report")

def main():
    parser = argparse.ArgumentParser(description="Run universe rotation report")
    ...
    logger.info(f"Running universe rotation report. Profile: {args.profile}")
    df, summary = pipeline.build_universe_rotation_report(
         specs=specs,
