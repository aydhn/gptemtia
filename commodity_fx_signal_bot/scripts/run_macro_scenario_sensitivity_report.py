...
def main():
    parser = argparse.ArgumentParser(description="Run Macro Scenario Sensitivity Report")
    ...
    logger.info(f"Running macro scenario sensitivity report for {len(specs)} symbols on timeframe {args.timeframe}")
    ...
    df, summary = pipeline.build_macro_scenario_sensitivity_report(
        specs,
