...
logger = logging.getLogger("run_composite_index_report")

def main():
    parser = argparse.ArgumentParser(description="Run composite index report")
    ...
    logger.info(f"Running composite index report for {len(specs)} symbols. Profile: {args.profile}")
    summary, tables = pipeline.build_composite_index_report(
         specs=specs,
