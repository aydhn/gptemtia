...
def main():
    parser = argparse.ArgumentParser(description="Run lifecycle quality report")
    ...
    print(f"Running Run lifecycle quality report with profile {args.profile}...")
    pipeline.build_lifecycle_quality_report(save=args.save)
    print("Done.")
