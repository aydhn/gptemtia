...
def main():
    parser = argparse.ArgumentParser(description="Run Scenario Regression Status")
    ...
    df, summary = pipeline.build_scenario_regression_status(save=save)
    print("Scenario Regression Status generated.")
    print(summary)
