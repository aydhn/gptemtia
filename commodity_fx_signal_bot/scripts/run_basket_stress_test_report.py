...
def main():
    parser = argparse.ArgumentParser(description="Run Basket Stress Test Report")
    ...
    logger.info(f"Running basket stress test report for {len(specs)} symbols on timeframe {args.timeframe}")
    ...
    tables, summary = pipeline.build_basket_stress_test_report(
        specs,
