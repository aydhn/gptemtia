...
_INDICATOR_SPECS = [
    ...
    IndicatorSpec(
        ...
        {"indicator_col": "rsi_14", "direction": "bullish"},
        ("close", "rsi_14"),
        (),
        80,
    ),
    IndicatorSpec(
        "divergence_feature_frame",
        "divergence",
    ...
    IndicatorSpec(
        "compact_divergence_features",
        "divergence",
        "build_compact_divergence_features",
        {},
        ("close",),
        (),
        80,
