...
from .condition_library import (
    condition_column_gt,
    condition_column_gte,
    condition_column_lt,
    condition_column_lte,
    ...
    return [
        RuleTemplate(
            ...
            conditions=tuple(
                [
                    condition_label_contains(
                        "strategy_family", "trend_following", required=True
                    ),
                    condition_label_contains(
                        "strategy_status", "candidate", required=True
                    ),
    ...
    return [
        RuleTemplate(
            ...
            conditions=tuple(
                [
                    condition_label_contains(
                        "strategy_family", "momentum_continuation", required=True
                    ),
    ...
    return [
        RuleTemplate(
            ...
            conditions=tuple(
                [
                    condition_label_contains(
                        "strategy_family", "mean_reversion", required=True
                    ),
    ...
    return [
        RuleTemplate(
            ...
            conditions=tuple(
                [
                    condition_label_contains(
                        "strategy_family", "breakout", required=True
                    ),
    ...
    return [
        RuleTemplate(
            ...
            conditions=tuple(
                [
                    condition_label_contains(
                        "strategy_family", "pullback", required=True
                    ),
                    condition_column_lt("conflict_score", 0.5, weight=1.0),
                ]
                + pullback_context_conditions()
    ...
    return [
        RuleTemplate(
            ...
            conditions=tuple(
                [
                    condition_label_contains(
                        "strategy_family", "divergence_reversal", required=True
                    ),
    ...
    return [
        RuleTemplate(
            ...
            conditions=tuple(
                [
                    condition_label_contains(
                        "strategy_family", "range_reversion", required=True
                    ),
    ...
    return [
        RuleTemplate(
            ...
            conditions=tuple(
                [
                    condition_label_contains(
                        "strategy_family", "watchlist", required=True
                    )
                ]
            ),
            min_required_conditions=1,
