from sizing.sizing_candidate import build_sizing_id, build_sizing_candidate_from_evaluation, sizing_candidate_to_dict
import pandas as pd
...
def test_build_sizing_candidate_from_evaluation():
    risk_row = pd.Series({"risk_id": "r1", "risk_readiness_score": 0.8}, name="2023-01-01")
    eval_ctx = {
