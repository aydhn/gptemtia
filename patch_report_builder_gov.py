...
new_methods = """
    ...
    def build_artifact_inventory_text_report(self, summary: dict, inventory_df=None) -> str:
    ...
    def build_lineage_graph_text_report(self, summary: dict, node_df=None, edge_df=None) -> str:
    ...
    def build_provenance_text_report(self, summary: dict, provenance_df=None) -> str:
    ...
    def build_dependency_trace_text_report(self, summary: dict, trace_df=None) -> str:
    ...
    def build_audit_trail_text_report(self, summary: dict, audit_df=None) -> str:
    ...
    def build_research_governance_text_report(self, summary: dict, checklist_df=None) -> str:
    ...
    def build_governance_status_report(self, status_df=None, summary: dict={}) -> str:
...
if "build_artifact_inventory_text_report" not in content:
    content += new_methods
    with open(path, "w") as f:
        f.write(content)
    print("Updated report_builder.py")
else:
    print("Methods already exist in report_builder.py")
