# -*- coding: utf-8 -*-
"""Phase 155: Risk Reporting Data Snooping Bias Guards."""
...
def build_risk_reporting_data_snooping_bias_guard_registry(
    ...
    rows = [
        RiskReportingGuardItem(
            guard_name="risk_reporting_data_snooping_bias_guard",
            domain="bias_guard",
            guard_rule="Enforces fixed parameter specifications and prohibits ex-post limit curve fitting",
            is_active=True,
