# -*- coding: utf-8 -*-
"""Phase 155: Volatility Limit Monitoring Contracts Registry."""
...
def build_volatility_limit_monitoring_contract_registry(
    profile: RiskReportingProfile = None,
) -> Tuple[pd.DataFrame, Dict[str, Any]]:
    """Build DataFrame and summary for volatility limit monitoring contracts."""
    if profile is None:
        profile = get_default_risk_reporting_profile()

    rows = [
        LimitMonitoringContract(
            contract_name="portfolio_volatility_limit",
            limit_family="volatility_limit",
            description="Portfoy yilliklandirilmis oynaklik tavan izleme sozlesmesi",
