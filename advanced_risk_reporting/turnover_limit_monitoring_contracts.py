# -*- coding: utf-8 -*-
"""Phase 155: Turnover Limit Monitoring Contracts Registry."""
...
def build_turnover_limit_monitoring_contract_registry(
    profile: RiskReportingProfile = None,
) -> Tuple[pd.DataFrame, Dict[str, Any]]:
    """Build DataFrame and summary for turnover limit monitoring contracts."""
    if profile is None:
        profile = get_default_risk_reporting_profile()

    rows = [
        LimitMonitoringContract(
            contract_name="portfolio_turnover_limit",
            limit_family="turnover_limit",
            description="Rebalance basi donus hizi tavan izleme sozlesmesi",
            limit_type="soft_warning",
            threshold_metadata="turnover <= 0.30",
            is_placeholder=True,
