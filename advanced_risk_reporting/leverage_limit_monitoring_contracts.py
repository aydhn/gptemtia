# -*- coding: utf-8 -*-
"""Phase 155: Leverage Limit Monitoring Contracts Registry."""
...
def build_leverage_limit_monitoring_contract_registry(
    profile: RiskReportingProfile = None,
) -> Tuple[pd.DataFrame, Dict[str, Any]]:
    """Build DataFrame and summary for leverage limit monitoring contracts."""
    if profile is None:
        profile = get_default_risk_reporting_profile()

    rows = [
        LimitMonitoringContract(
            contract_name="portfolio_max_leverage_limit",
            limit_family="leverage_limit",
            description="Maksimum kaldirac orani tavan izleme sozlesmesi",
