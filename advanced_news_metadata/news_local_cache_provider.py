...
class NewsLocalCacheProviderPlaceholder(BaseNewsMetadataProvider):
    ...
    def metadata(self) -> NewsProviderMetadata:
        ...
        return NewsProviderMetadata(
            ...
            "Local cache news metadata provider", "data/lake/advanced_news_metadata/placeholders/", "local",
    ...
    def fetch_news_metadata(self, request: NewsProviderRequest) -> NewsProviderResponse:
        return create_news_provider_response(
            ...
            output_ref="data/lake/advanced_news_metadata/placeholders/cached_news.csv",
            row_count=0,
            schema_ref="news_metadata_schema_contract",
            warnings=["Local cache placeholder; metadata only."],
...
def build_news_local_cache_provider_placeholder(profile: NewsProviderProfile) -> Tuple[pd.DataFrame, Dict]:
    provider = NewsLocalCacheProviderPlaceholder()
