"""run_terminal_reproducibility_governance"""
import sys
...
def main():
    ...
    print(f"Running run_terminal_reproducibility_governance...")
    pipeline.build_terminal_reproducibility_governance(save=args.save)
    print("Done.")
