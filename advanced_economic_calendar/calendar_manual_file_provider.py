...
class CalendarManualFileProviderPlaceholder(BaseCalendarProvider):
    provider_name = "calendar_manual_file_provider_placeholder"
...
def build_calendar_manual_file_provider_placeholder(profile: CalendarProviderProfile) -> Tuple[pd.DataFrame, Dict]:
    df = pd.DataFrame([vars(CalendarManualFileProviderPlaceholder().metadata())])
