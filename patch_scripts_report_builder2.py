...
for script in scripts_to_patch:
    ...
    content = content.replace("from reports.report_builder import report_builder", "from reports.report_builder import ReportBuilder")
    content = content.replace("txt_content = report_builder", "report_builder_inst = ReportBuilder(paths)\n    txt_content = report_builder_inst")
