...
test_files = [
    "test_calendar_provider_config.py",
    "test_calendar_provider_labels.py",
    "test_calendar_provider_models.py",
    "test_calendar_provider_profile_registry.py",
    "test_calendar_domain_registry.py",
    "test_economic_event_universe.py",
    "test_economic_event_categories.py",
    "test_economic_event_importance.py",
    "test_event_indicator_mapping.py",
    "test_calendar_event_schema.py",
    "test_release_event_schema.py",
    "test_event_surprise_requirements.py",
    "test_event_time_normalization_requirements.py",
    "test_event_revision_handling_requirements.py",
    "test_calendar_provider_capabilities.py",
    "test_calendar_provider_metadata.py",
    "test_calendar_provider_request.py",
    "test_calendar_provider_response.py",
    "test_calendar_provider_errors.py",
    "test_calendar_provider_interfaces.py",
    "test_calendar_adapter_contracts.py",
    "test_calendar_provider_registry.py",
    "test_calendar_provider_resolver.py",
    "test_calendar_provider_preference_resolver.py",
    "test_calendar_provider_capability_matcher.py",
    "test_calendar_dry_run_fixture.py",
    "test_calendar_manual_file_provider.py",
    "test_calendar_local_cache_provider.py",
    "test_calendar_official_api_provider.py",
    "test_calendar_licensed_provider.py",
    "test_calendar_public_dataset_provider.py",
    "test_calendar_output_validation.py",
    "test_calendar_safety_boundary.py",
    "test_calendar_health.py",
    "test_calendar_scoring.py",
    "test_calendar_validation.py",
    "test_calendar_quality.py",
    "test_calendar_report_builder.py",
...
for f in test_files:
    with open(f"tests/{f}", "w", encoding="utf-8") as out:
        out.write(base_test_content)

unified_test_content = """import pytest
...
"""
with open("tests/test_advanced_calendar_provider_scripts_contract.py", "w", encoding="utf-8") as out:
    out.write(unified_test_content)
