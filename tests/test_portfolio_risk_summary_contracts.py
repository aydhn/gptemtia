# -*- coding: utf-8 -*-
"""Unit tests for Phase 155 Portfolio Risk Summary Contracts."""

from advanced_risk_reporting.risk_reporting_config import get_default_risk_reporting_profile
from advanced_risk_reporting.portfolio_risk_summary_contracts import build_portfolio_risk_summary_contract_registry


def test_build_portfolio_risk_summary_contract_registry():
    profile = get_default_risk_reporting_profile()
    df, summary = build_portfolio_risk_summary_contract_registry(profile)
