# -*- coding: utf-8 -*-
"""Phase 151 Unit Tests: benchmark_comparison_report_contracts."""
...
def test_build_benchmark_comparison_report_contract_registry():
    profile = get_default_benchmark_evaluation_profile()
    df, summary = build_benchmark_comparison_report_contract_registry(profile)
