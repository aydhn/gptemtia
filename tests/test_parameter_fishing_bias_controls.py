# -*- coding: utf-8 -*-
"""Phase 150 Unit Tests: Parameter Fishing Bias Controls."""
...
from advanced_backtest_governance.parameter_fishing_bias_controls import (
    ...
    PARAMETER_FISHING_CONTROLS,
)


def test_build_parameter_fishing_bias_controls():
    profile = get_default_backtest_governance_profile()
    df, summary = build_parameter_fishing_bias_control_registry(profile)
    ...
    assert len(PARAMETER_FISHING_CONTROLS) == 3
