# -*- coding: utf-8 -*-
"""Phase 150 Unit Tests: Overfitting Bias Controls."""
...
def test_build_overfitting_bias_controls():
    profile = get_default_backtest_governance_profile()
    df, summary = build_overfitting_bias_control_registry(profile)
    ...
    assert len(OVERFITTING_CONTROLS) == 3
