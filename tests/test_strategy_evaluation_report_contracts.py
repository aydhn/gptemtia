# -*- coding: utf-8 -*-
"""Phase 151 Unit Tests: strategy_evaluation_report_contracts."""
...
def test_build_strategy_evaluation_report_contract_registry():
    profile = get_default_benchmark_evaluation_profile()
    df, summary = build_strategy_evaluation_report_contract_registry(profile)
