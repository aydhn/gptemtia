# -*- coding: utf-8 -*-
"""Unit tests for Risk Metric Placeholders."""

from advanced_risk_reporting.risk_reporting_config import get_default_risk_reporting_profile
from advanced_risk_reporting.risk_metric_placeholders import build_risk_metric_placeholder_registry


def test_build_risk_metric_placeholder_registry():
    profile = get_default_risk_reporting_profile()
    df, summary = build_risk_metric_placeholder_registry(profile)
