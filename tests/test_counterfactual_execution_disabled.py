# -*- coding: utf-8 -*-
"""Unit tests for Phase 143 Counterfactual Execution Disabled Safeguard."""
...
from advanced_explainability_attribution.counterfactual_execution_disabled import (
    ...
    summarize_counterfactual_execution_disabled,
)


def test_counterfactual_execution_disabled():
    df, summary = verify_counterfactual_execution_disabled()
    assert len(df) == 4
