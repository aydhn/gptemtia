# -*- coding: utf-8 -*-
"""Phase 150 Unit Tests: Survivorship Bias Controls."""
...
def test_build_survivorship_bias_controls():
    profile = get_default_backtest_governance_profile()
    df, summary = build_survivorship_bias_control_registry(profile)
    ...
    assert len(SURVIVORSHIP_CONTROLS) == 3
