# -*- coding: utf-8 -*-
"""Phase 150 Unit Tests: Regime Coverage Bias Controls."""
...
def test_build_regime_coverage_bias_controls():
    profile = get_default_backtest_governance_profile()
    df, summary = build_regime_coverage_bias_control_registry(profile)
