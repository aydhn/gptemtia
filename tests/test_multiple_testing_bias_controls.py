# -*- coding: utf-8 -*-
"""Phase 150 Unit Tests: Multiple Testing Bias Controls."""
...
def test_build_multiple_testing_bias_controls():
    profile = get_default_backtest_governance_profile()
    df, summary = build_multiple_testing_bias_control_registry(profile)
    ...
    assert len(MULTIPLE_TESTING_CONTROLS) == 3
