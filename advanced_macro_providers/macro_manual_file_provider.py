...
class MacroManualFileProviderPlaceholder(BaseMacroProvider):
...
def build_macro_manual_file_provider_placeholder(profile: MacroProviderProfile) -> tuple[pd.DataFrame, dict]:
    return pd.DataFrame([{"provider": "macro_manual_file_provider_placeholder"}]), {"status": "placeholder"}
