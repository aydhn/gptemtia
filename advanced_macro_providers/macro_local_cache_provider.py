...
class MacroLocalCacheProviderPlaceholder(BaseMacroProvider):
...
def build_macro_local_cache_provider_placeholder(profile: MacroProviderProfile) -> tuple[pd.DataFrame, dict]:
    return pd.DataFrame([{"provider": "macro_local_cache_provider_placeholder"}]), {"status": "placeholder"}
