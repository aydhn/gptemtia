...
class MacroOfficialApiProviderPlaceholder(BaseMacroProvider):
...
def build_macro_official_api_provider_placeholder(profile: MacroProviderProfile) -> tuple[pd.DataFrame, dict]:
    return pd.DataFrame([{"provider": "macro_official_api_provider_placeholder"}]), {"status": "placeholder"}
