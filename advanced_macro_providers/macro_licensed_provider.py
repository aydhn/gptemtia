...
class MacroLicensedProviderPlaceholder(BaseMacroProvider):
...
def build_macro_licensed_provider_placeholder(profile: MacroProviderProfile) -> tuple[pd.DataFrame, dict]:
    return pd.DataFrame([{"provider": "macro_licensed_provider_placeholder"}]), {"status": "placeholder"}
